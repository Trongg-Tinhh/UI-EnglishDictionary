...
public class UserService {
    ...
    public ResponseEntity<String> Register(@PathVariable("registerForm") @NonNull RegisterForm registerForm, String code) {
        try {
            ...
            String url = Host + Port + "/api/user/new/"+code;
            ResponseEntity<String> response = restTemplate.postForEntity(url, request, String.class);
            return response;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public User getUserInfo(String userId) {
        RestTemplate restTemplate = new RestTemplate();
        String url = Host + Port + "/api/user/" + userId + "/profile";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
    ...
    public String getAvt(String userId) {
        RestTemplate restTemplate = new RestTemplate();
        String url = Host + Port + "/api/user/profile/avatar/" + userId;
    ...
    public ResponseEntity<String> updateUser(@PathVariable("user") @NonNull User user, String userId) {
        try {
            ...
            String url = Host + Port + "/api/user/profile/" + userId;
    ...
    {
        RestTemplate restTemplate = new RestTemplate();
        String url = Host + Port + "/api/user/gender";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<String> entity = new HttpEntity<>(headers);
    ...
    {
        RestTemplate restTemplate = new RestTemplate();
        String url = Host + Port + "/api/user/level";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<String> entity = new HttpEntity<>(headers);
        ResponseEntity<Map> response = restTemplate.exchange(url, HttpMethod.GET, entity, Map.class);
    ...
    {
        RestTemplate restTemplate = new RestTemplate();
        String url = Host + Port + "/api/user/occupation";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        HttpEntity<String> entity = new HttpEntity<>(headers);
        ResponseEntity<Map> response = restTemplate.exchange(url, HttpMethod.GET, entity, Map.class);
    ...
    public ResponseEntity<String> updateAvatar(MultipartFile file, String userId) {
        try {
            RestTemplate restTemplate = new RestTemplate();
            String url = Host + "4040" + "/api/user/profile/files/"+userId;
    ...
    {
        RestTemplate restTemplate = new RestTemplate();
        String url = Host + Port + "/api/user/verify";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
    ...
    public ResponseEntity<String> changePassword(@PathVariable("loginForm") @NonNull LoginForm loginForm, String userId) {
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            HttpEntity<LoginForm> request = new HttpEntity<>(loginForm, headers);
            String url = Host + Port + "/api/user/" + userId;
            ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.PUT, request, String.class);
            return response;
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public ResponseEntity<String> resetPassword(@PathVariable("loginForm") @NonNull LoginForm loginForm, String code) {
        try {
            ...
            headers.setContentType(MediaType.APPLICATION_JSON);
            HttpEntity<LoginForm> request = new HttpEntity<>(loginForm, headers);
            String url = Host + Port + "/api/user/reset/password/" + code;
            ResponseEntity<String> response = restTemplate.postForEntity(url, request, String.class);
            return response;
        } catch (Exception e) {
            e.printStackTrace();
